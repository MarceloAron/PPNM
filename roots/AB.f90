...
program exAB
  ...
  calls = 0
  call newton(syst_eq,x,h,eps,steps)
  ...
  write(*,*) "Starting point:", x
  calls = 0
  call newton(gradient_rosen,x,h,eps,steps)
  write(*,*) "Number of times function was called:", calls
  write(*,*) "Number of steps:", steps
  write(*,*) "Root=", x
  ...
  write(*,*) "Starting point:", x
  calls = 0
  call newton(gradient_himmel,x,h,eps,steps)
  write(*,*) "Number of times function was called:", calls
  write(*,*) "Number of steps:", steps
  write(*,*) "Root=", x
  ...
  write(*,*) "Starting point:", x
  calls = 0
  call newton_analyt_jac(syst_eq,x,eps,jacobian_syst,steps)
  write(*,*) "Number of times function was called:", calls
  write(*,*) "Number of steps:", steps  
  write(*,*) "Root=", x
  write(*,*) "Gradient=", syst_eq(x)
  ...
  write(*,*) "Starting point:", x
  calls = 0
  call newton_analyt_jac(gradient_rosen,x,eps,jacobian_rosen,steps)
  write(*,*) "Number of times function was called:", calls
  write(*,*) "Number of steps:", steps    
  write(*,*) "Root=", x
  write(*,*) "Gradient=", gradient_rosen(x)
  ...
  write(*,*) "Starting point:", x
  calls = 0
  call newton_analyt_jac(gradient_himmel,x,eps,jacobian_himmel,steps)
  write(*,*) "Number of times function was called:", calls
  write(*,*) "Number of steps:", steps
  write(*,*) "Root=", x
  write(*,*) "Gradient=", gradient_himmel(x)
