...
program main
  ...
  write(0,*) "Examination project number 16: Classical 4th order Runge-Kutta ODE"
  write(0,*) "stepper with step-doubling error estimate."
...
!  allocate(y(2))
  y = [0,1]
  write(0,"(x,A20,x,F9.7)") "Absolute precision =", acc
  write(0,"(x,A20,x,F9.7)") "Relative precision =", eps
  write(0,*)
  write(0,*) "ODE: u'' = -u"
  ...
  write(0,"(x,A10,2x,F11.9)") "Integral =", y(1)
  write(0,"(x,A11,x,F11.9)") "Should be =", 2d0
  ...
  b = 5
  y = [0]
  write(0,"(x,A9,x,F3.1,x,A2,x,F3.1)") "Interval:", a, "to", b
  path = driver(integ_two,a,y,b,acc,eps)
  write(0,"(x,A10,2x,F11.9)") "Integral =", y(1)
  write(0,"(x,A6,6x,F11.9)") "Should be =", 0.5d0
  ...
  b = 1
  y = [0]
  write(0,"(x,A9,x,F10.8,x,A2,x,F3.1)") "Interval:", a, "to", b
  path = driver(integ_three,a,y,b,acc,eps)
  write(0,"(x,A10,2x,F11.9)") "Integral =", y(1)
  write(0,"(x,A6,6x,F11.9)") "Should be =", 1.9998d0
